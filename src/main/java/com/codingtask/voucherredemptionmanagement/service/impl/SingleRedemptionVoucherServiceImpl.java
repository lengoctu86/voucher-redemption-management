...
import com.codingtask.voucherredemptionmanagement.service.validator.SingleRedemptionVoucherValidator;
...
@Transactional
@AllArgsConstructor
public class SingleRedemptionVoucherServiceImpl extends SingleRedemptionVoucherValidator implements VoucherService {
    private final VoucherRepository voucherRepository;

    @Override
    public VoucherDTO createVoucher(VoucherRequestDTO dto) {
        validateSingleRedemptionVoucher(dto);
